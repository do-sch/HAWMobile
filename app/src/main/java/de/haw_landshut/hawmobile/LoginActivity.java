...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFacultyView = ((Spinner) findViewById(R.id.faculties));
        mFacultyView.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
    ...
    private boolean isEmailValid(String email) {
        return email.matches("(s-[a-zA-Z0-9]{6})|[A-Z][a-z]+\\.[A-Z][a-z]+[0-9]");
    }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            if(connectionEstablished){
                ...
                boolean worked = accountManager.addAccountExplicitly(account, mPassword, fak);
